...
public class Skidmarks : MonoBehaviour {
	...
	[SerializeField]
	Material skidmarksMaterial = null; // Material for the skidmarks to uses

	// END INSPECTOR SETTINGS

	const int MAX_MARKS = 16384; // Max number of marks total for everyone together
	...
	const float MAX_OPACITY = .90f; // Max skidmark opacity
